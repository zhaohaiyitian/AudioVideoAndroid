...
import com.jack.audiovideoandroid.opengl.ScreenFilter.Companion.SHADER_TYPE_FRAGMENT
import com.jack.audiovideoandroid.opengl.ScreenFilter.Companion.SHADER_TYPE_VERTEX
 ...
 * desc:
 */
class ShapeFilter(context: Context) {
